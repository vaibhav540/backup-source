...
import { useTheme } from "../context/ThemeContext";
import useChat from "../hooks/useChat";
import { setIsFirstLoading, setSegment, setSessionID,setSelectedTabGlobal, setUploadedImage, clearUploadedImage, setReconstructedQuestion, clearReconstructedQuestion } from "../redux/actions";
import ChatManager from "./shared/ChatManager";
import { useLocation } from "react-router-dom";
...
const ChatInterface = () => {
  ...
  const handleVariantSelect = (variant) => {
    setSelectedTab(variant);
    dispatch(setSelectedTabGlobal(variant));
    setShowVariantModal(false);
    setInput("");
    dispatch(clearUploadedImage());
    dispatch(clearReconstructedQuestion());
